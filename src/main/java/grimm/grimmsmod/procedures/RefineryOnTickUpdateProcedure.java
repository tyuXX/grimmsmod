...
public class RefineryOnTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 0)).getItem() == Items.BLAZE_POWDER) {
			tmp = "craft:refinery$" + (BuiltInRegistries.ITEM.getKey((new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					if (world instanceof ILevelExtension _ext) {
						IItemHandler _itemHandler = _ext.getCapability(Capabilities.ItemHandler.BLOCK, pos, null);
						if (_itemHandler != null)
			...
			if (GrimmsModVariables.cache.contains(tmp)) {
				...
				if ((new Object() {
				...
				}.getItemStack(world, BlockPos.containing(x, y, z), 2)).getItem() == itemout.getItem() || (new Object() {
					public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
						if (world instanceof ILevelExtension _ext) {
							IItemHandler _itemHandler = _ext.getCapability(Capabilities.ItemHandler.BLOCK, pos, null);
							if (_itemHandler != null)
					...
					}.getItemStack(world, BlockPos.containing(x, y, z), 2)).getMaxStackSize() > new Object() {
