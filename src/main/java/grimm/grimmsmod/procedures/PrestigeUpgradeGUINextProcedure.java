...
public class PrestigeUpgradeGUINextProcedure {
	public static void execute(Entity entity, HashMap guistate) {
		...
		if (!(((GrimmsModVariables.cache.get("menu:prestige")) instanceof ListTag _listTag ? _listTag.copy() : new ListTag())
		...
		if (guistate.get("text:prestigeupgradeid") instanceof EditBox _tf)
			_tf.setValue(((((GrimmsModVariables.cache.get("menu:prestige")) instanceof ListTag _listTag ? _listTag.copy() : new ListTag())
