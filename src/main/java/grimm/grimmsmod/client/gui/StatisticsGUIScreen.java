...
public class StatisticsGUIScreen extends AbstractContainerScreen<StatisticsGUIMenu> {
	private final static HashMap<String, Object> guistate = StatisticsGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public StatisticsGUIScreen(StatisticsGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("grimms:textures/screens/statistics_gui.png");
