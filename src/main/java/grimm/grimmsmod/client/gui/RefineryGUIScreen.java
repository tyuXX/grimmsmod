...
public class RefineryGUIScreen extends AbstractContainerScreen<RefineryGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("grimms:textures/screens/refinery_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.grimms.refinery_gui.label_blaze_powder"), 33, 61, -12829636, false);
	}
