...
import grimm.grimmsmod.item.VariablePressureTankItem;
import grimm.grimmsmod.item.ValveItem;
...
import grimm.grimmsmod.item.SoulPiercerItem;
...
import grimm.grimmsmod.item.LongSwordItem;
...
import grimm.grimmsmod.item.HeatingElementItem;
...
import grimm.grimmsmod.item.FaultyNecromancersWandItem;
...
import grimm.grimmsmod.item.CopperWireItem;
import grimm.grimmsmod.item.CoolingElementItem;
...
import grimm.grimmsmod.item.CleanBoneItem;
import grimm.grimmsmod.item.CharredBoneItem;
...
public class GrimmsModItems {
	...
	public static final DeferredHolder<Item, Item> PRESSURE_TANK = REGISTRY.register("pressure_tank", PressureTankItem::new);
	public static final DeferredHolder<Item, Item> VARIABLE_PRESSURE_TANK = REGISTRY.register("variable_pressure_tank", VariablePressureTankItem::new);
	public static final DeferredHolder<Item, Item> VALVE = REGISTRY.register("valve", ValveItem::new);
	public static final DeferredHolder<Item, Item> PIPE = REGISTRY.register("pipe", PipeItem::new);
	public static final DeferredHolder<Item, Item> RESISTOR = REGISTRY.register("resistor", ResistorItem::new);
	public static final DeferredHolder<Item, Item> HEATING_ELEMENT = REGISTRY.register("heating_element", HeatingElementItem::new);
	public static final DeferredHolder<Item, Item> COOLING_ELEMENT = REGISTRY.register("cooling_element", CoolingElementItem::new);
	public static final DeferredHolder<Item, Item> COPPER_WIRE = REGISTRY.register("copper_wire", CopperWireItem::new);
	public static final DeferredHolder<Item, Item> FAULTY_NECROMANCERS_WAND = REGISTRY.register("faulty_necromancers_wand", FaultyNecromancersWandItem::new);
	public static final DeferredHolder<Item, Item> CLEAN_BONE = REGISTRY.register("clean_bone", CleanBoneItem::new);
	public static final DeferredHolder<Item, Item> CHARRED_BONE = REGISTRY.register("charred_bone", CharredBoneItem::new);
