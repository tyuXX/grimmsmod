...
public class GrimmsModKeyMappings {
	...
	public static final KeyMapping OPEN_ITEM_ATTRIBUTION_MENU = new KeyMapping("key.grimms.open_item_attribution_menu", GLFW.GLFW_KEY_Z, "key.categories.grimmsmod");
