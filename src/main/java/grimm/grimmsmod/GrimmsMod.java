...
import grimm.grimmsmod.init.GrimmsModEntities;
...
public class GrimmsMod {
	public static final Logger LOGGER = LogManager.getLogger(GrimmsMod.class);
	public static final String MODID = "grimms";

	public GrimmsMod(IEventBus modEventBus) {
