...
import gsd.tyuxx.grimmsmod.procedures.OpenStatsOnKeyPressedProcedure;
...
public record OpenStatsMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<OpenStatsMessage> TYPE = new Type<>(new ResourceLocation(GrimmsmodMod.MODID, "key_open_stats"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		GrimmsmodMod.addNetworkMessage(OpenStatsMessage.TYPE, OpenStatsMessage.STREAM_CODEC, OpenStatsMessage::handleData);
	}
}
