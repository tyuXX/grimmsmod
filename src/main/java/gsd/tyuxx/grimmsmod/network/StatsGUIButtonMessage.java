...
import gsd.tyuxx.grimmsmod.procedures.PrestigeHandleProcedure;
...
public record StatsGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<StatsGUIButtonMessage> TYPE = new Type<>(new ResourceLocation(GrimmsmodMod.MODID, "stats_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		GrimmsmodMod.addNetworkMessage(StatsGUIButtonMessage.TYPE, StatsGUIButtonMessage.STREAM_CODEC, StatsGUIButtonMessage::handleData);
	}
}
